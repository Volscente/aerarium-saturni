...
function Label({
  ...
  return (
    <label
      htmlFor={htmlFor}
      className="block text-xs font-medium text-roman-stone mb-1"
    >
      {children}
    </label>
  );
...
export function EtfForm({ onSuccess, etf }: EtfFormProps): JSX.Element {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <Label htmlFor="german_tax_classification">
          German Tax Classification
        </Label>
        <input
      ...
      <div>
        <Label htmlFor="dividend_frequency">
          Dividend Frequency (optional)
        </Label>
        <input
        ...
        <>
          ...
          <div>
            <Label htmlFor="monthly_volume">
              Monthly Volume in EUR (optional)
            </Label>
            <input
              id="monthly_volume"
              type="number"
      ...
      {isBonds && (
        <>
          ...
          <div>
            <Label htmlFor="bond_credit_scores">
              Bond Credit Scores (JSON)
            </Label>
            <textarea
